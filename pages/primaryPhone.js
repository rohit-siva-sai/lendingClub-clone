...
import { MdArrowBackIosNew,MdArrowBackIos } from "react-icons/md";
        ...
        <div>
          {showOtp ? (
            ...
            <div className="w-full  flex flex-col items-start space-y-8 rounded-lg  bg-white">
              ...
              <div className="flex justify-center mx-auto  items-center space-x-4 ">
                <Link href={"/primaryEmail"} onClick={updateDecreaseProgress}>
                  <div className="hover:bg-gray-100 bg-white py-2 pl-4 pr-2 shadow-md rounded  flex justify-center">
